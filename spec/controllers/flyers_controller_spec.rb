...
RSpec.describe FlyersController, :type => :controller do
  ...
  # Flyer. As you add validations to Flyer, be sure to
  ...
  # FlyersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created flyer" do
        post :create, {:flyer => valid_attributes}, valid_session
        expect(response).to redirect_to(Flyer.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved flyer as @flyer" do
        post :create, {:flyer => invalid_attributes}, valid_session
        expect(assigns(:flyer)).to be_a_new(Flyer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested flyer" do
        flyer = Flyer.create! valid_attributes
        put :update, {:id => flyer.to_param, :flyer => new_attributes}, valid_session
        flyer.reload
      ...
      it "redirects to the flyer" do
        flyer = Flyer.create! valid_attributes
        put :update, {:id => flyer.to_param, :flyer => valid_attributes}, valid_session
        expect(response).to redirect_to(flyer)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the flyer as @flyer" do
        flyer = Flyer.create! valid_attributes
        put :update, {:id => flyer.to_param, :flyer => invalid_attributes}, valid_session
        expect(assigns(:flyer)).to eq(flyer)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the flyers list" do
      flyer = Flyer.create! valid_attributes
      delete :destroy, {:id => flyer.to_param}, valid_session
      expect(response).to redirect_to(flyers_url)
    end
  end
